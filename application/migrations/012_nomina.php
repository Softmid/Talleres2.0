...
class Migration_nomina extends CI_Migration {
	...
	public function up()
	{
		$fields = array(
            ...
            "`valuacion_estatica` decimal(11,4) DEFAULT NULL",
            "`30_estatica` decimal(11,4) DEFAULT NULL",
            "`pago_estatica` decimal(11,4) DEFAULT NULL",
		...
		$this->db->simple_query('ALTER TABLE  `nomina` AUTO_INCREMENT=1 DEFAULT CHARSET=utf8');
